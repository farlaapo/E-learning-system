...
CREATE TYPE payment_method AS ENUM (
    'Stripe', 'PayPal', 'MobileMoney', 'Card', 'BankTransfer', 'Other'
);
...
BEGIN
   INSERT INTO payments (
      ...
      transaction_ref, description, plan_name, start_date, end_date,
      renewal_date, cancelled_at, provider_ref, is_recurring
   ) VALUES (
      p_id, p_user_id, p_role, p_amount, p_currency, p_method, p_type, p_status,
      p_transaction_ref, p_description, p_plan_name, p_start_date, p_end_date,
      p_renewal_date, p_cancelled_at, p_provider_ref, p_is_recurring
   );
END;
$$;
